...
5. La flecha de la cabecera vuelve al menú de grupos, también desde una búsqueda.
...
| RF-5 | Con el campo vacío se muestran los diez grupos de ubicaciones y, si hay trazados, el grupo `CL · Calles`. Cada fila conserva la geometría de una ubicación y usa un pin gris decorativo. |
| RF-6 | Pulsar un grupo muestra su contenido; la flecha fija sustituye a la lupa y vuelve al menú, sin fila final de retorno. Cualquier consulta no vacía busca globalmente y también permite volver con la flecha. |
...
| RF-13 | Las calles se consultan por su grupo o por búsqueda. Pulsar su nombre despliega únicamente el minimapa con una línea resaltada, sin pin, coordenadas copiables ni enlace a Google Maps. Incluye los nombres de feria y las referencias policiales indicadas. |
